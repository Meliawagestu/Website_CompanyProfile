...
$haji1 = mysqli_query($conn,"SELECT * FROM tbl_ketentuan WHERE id IN ('11') ");

$haji2 = mysqli_query($conn,"SELECT * FROM tbl_ketentuan WHERE id IN ('14') ");
...
<html lang="en" id="home">
  ...
  <body>
    ...
    <div class="jumbotron jumbotron bg-cover">
      ...
      <div class="container">
        <br><br><br>
      <h1 class="text-center"><b>PAKET HAJI</b></h1> 
      </div>
    </div>
  </div>
...
background-color: #d8aae0;
  ...
  <section class="ketentuan" id="ketentuan">
    ...
    <div class="row">
      <?php while($ketentuan =$haji1->fetch_array()):  ?>
  ...
  <section class="ketentuan" id="ketentuan">
    ...
    <div class="row">
      <?php while($ketentuan =$haji2->fetch_array()):  ?>
